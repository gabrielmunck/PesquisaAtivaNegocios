            ...
            <div className="space-y-8 max-w-3xl mx-auto">
                <div className="flex items-center gap-3">
                    <svg
                        ...
                        strokeWidth={1.5}
                        stroke="currentColor"
                        className="hidden md:flex w-8 h-8 text-white"
                    >
                        <path
                            strokeLinecap="round"
                ...
                <div className="mt-8">
                    ...
                    <ul className="text-white space-y-4 list-disc pl-6">
                        <li>
                            <strong>
                                Certificação SSL (Secure Socket Layer):
                            </strong>
                            Conexão criptografada para proteger seus dados
                            durante a navegação.
                        </li>
                        <li>
                            <strong>Certificação ISO 27001:</strong> Garantia de
                            um sistema de gestão de segurança da informação
                            robusto.
                        </li>
                        <li>
                            <strong>Auditorias regulares:</strong> Realizamos
                            revisões frequentes para assegurar a integridade de
                            nossos sistemas.
                        </li>
                    </ul>
                </div>
